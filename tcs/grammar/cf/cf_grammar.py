...
class CFG(grammar.Grammar):
    ...
    A CFG is coded as follows:
        ...
        * kleene: cfg generating Kleene closure of generated language
    ...
    Functions:
        * unite: cfg generating language union of the one generated by this cfg and the one generated by given cfg
        * concat: cfg generating language concatenation of the one generated by this cfg and the one generated by given cfg
        * reverse: cfg generating rverse of the language generated by this cfg
...
# Validation
    ...
    @property
    def reverse(self):
        """Return cfg generating the reverse of the language generated by this CFG."""
        cfg = None
        # TODO
        return cfg

    def includes(self, input):
        """Return True iff the given string belongs to the language generated by this cfg"""
        # TODO
        return None
    
    @property
    def renamed(self):
        """Return a copy of this RG with nonterminals renamed as A, B, C, ...."""
        nt_dict = {}
        new_terminals = self.terminals
        if len(self.non_terminals) > 26:
            ...
            for left_part, right_parts in self.productions.items(): 
                ...
                for right_part in right_parts:
                    s = ''
                    for t in right_part:
                        if t in new_terminals:
                            s+=t
                        else:
                            s+=nt_dict[t]
                    new_prods[nt_dict[''.join(left_part)]].add(s)
            new_grammar = self.__class__(terminals=new_terminals, 
                                    non_terminals=new_non_terminals, 
                                    axiom=new_axiom, 
                                    productions=tools.Tools.simple_productions(new_prods))
        return new_grammar
